...
def suite():
    module_suite = unittest.makeSuite(ModuleTests)
    connection_suite = unittest.makeSuite(ConnectionTests)
    cursor_suite = unittest.makeSuite(CursorTests)
    thread_suite = unittest.makeSuite(ThreadTests)
    constructor_suite = unittest.makeSuite(ConstructorTests)
    ext_suite = unittest.makeSuite(ExtensionTests)
    closed_con_suite = unittest.makeSuite(ClosedConTests)
    closed_cur_suite = unittest.makeSuite(ClosedCurTests)
