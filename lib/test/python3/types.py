...
def suite():
    sqlite_type_suite = unittest.makeSuite(SqliteTypeTests)
    decltypes_type_suite = unittest.makeSuite(DeclTypesTests)
    colnames_type_suite = unittest.makeSuite(ColNamesTests)
    adaptation_suite = unittest.makeSuite(ObjectAdaptationTests)
    bin_suite = unittest.makeSuite(BinaryConverterTests)
    date_suite = unittest.makeSuite(DateTimeTests)
