...
def suite():
    connection_suite = unittest.makeSuite(ConnectionFactoryTests)
    cursor_suite = unittest.makeSuite(CursorFactoryTests)
    row_suite_compat = unittest.makeSuite(RowFactoryTestsBackwardsCompat)
    row_suite = unittest.makeSuite(RowFactoryTests)
    text_suite = unittest.makeSuite(TextFactoryTests)
    text_zero_bytes_suite = unittest.makeSuite(TextFactoryTestsWithEmbeddedZeroBytes)
